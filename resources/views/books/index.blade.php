            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="nav nav-pills card-header-pills">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('books.trash') }}" class="nav-link {{ Request::path() == 'books/path' ? 'active' : '' }}">Trash</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    @foreach ($books as $book)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('books.destroy', [$book->id]) }}" onsubmit="return confirm('Move book to trash?')" method="post" class="d-inline">
                                    @csrf
                                    @method('delete')
